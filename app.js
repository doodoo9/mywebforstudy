            ...
            if (map) {
                setTimeout(() => {
                    ...
                    if (isFlying && planeSprite && planeSprite.userData.currentLatLng) {
                        map.setView([planeSprite.userData.currentLatLng.lat, planeSprite.userData.currentLatLng.lng], map.getZoom());
        ...
        function animateFlight() {
            ...
            if (viewMode === 'map' && map) {
                ...
                if (planeSprite) {
                    ...
                    // Fix Direction: Remove Math.PI to fix inverted direction on Map
                    rotationQ.setFromAxisAngle(new THREE.Vector3(0, 0, 1), -pixelBearing);
